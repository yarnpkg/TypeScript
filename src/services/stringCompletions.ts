                ...
                if (dependencyNameMatch) {
                    ...
                    if (unqualified) {
                        ...
                        if (shouldGetCompletions) {
                            getCompletionEntriesForDirectoryFragment(subPath, packageDirectory, extensionOptions, program, host, /*moduleSpecifierIsRelative*/ false, /*exclude*/ undefined, result);
                        }
                    }
                }
            }
